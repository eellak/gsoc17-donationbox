...
$project_css_file       = get_post_meta( $current_post_id , '_db_project_stylesheet_file', true );
...
{
    echo '<input type="hidden" id="custom_stlye" name="custom_stlye" value="'. $project_css_file[0]['url'] .'"/>';
}
else
{
...
<div id="primary" class="content-area">
    ...
    <div id="content" class="site-content" role="main">
        ...
        <div id="instructions">
            <div class="instruction_line"><img src="/wp-content/themes/influence-child/images/red_dot.png"> Εάν θέλεις να ενισχύσεις το έργο που προβάλλεται και να παίξεις το παιχνίδι, βάλε κέρμα στον κερματοδέκτη.</div>
            <div class="instruction_line"><img src="/wp-content/themes/influence-child/images/red_dot.png"> Ενημερώσου και για άλλα έργα που μπορείς να ενισχύσεις κουνώντας το μοχλό δεξιά ή αριστερά.</div>
            <div class="instruction_line"><img src="/wp-content/themes/influence-child/images/red_dot.png"> Με τον κωδικό που αναγράφεται στην απόδειξη μάζεψε πόντους στο http://thecoopbox.commonslab.gr και πάρε ένα T-shirt δώρο με συνολικές δωρεές 30€.</div>
        </div>
...
//                            }
                ...
                <div id="goal">
                    <?php
//                        //$goal = get_post_custom_values( 'Goal' ); print $goal[0];
//                        echo get_field('goal');
                    ?>
                </div>
                <!-- Days Left END -->
